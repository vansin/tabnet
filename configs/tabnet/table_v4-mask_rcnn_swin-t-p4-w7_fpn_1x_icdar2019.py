model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            ...
            v0/swin-transformer/swin_tiny_224_b16x64_300e_imagenet
            _20210616_090925-66df6be6.pth""")),
    neck=dict(
        type='FPN',
...
work_dir = './work_dirs/table_v4-mask_rcnn_swin-t-p4-w7_fpn_1x_icdar2019'
gpu_ids = range(0, 1)
