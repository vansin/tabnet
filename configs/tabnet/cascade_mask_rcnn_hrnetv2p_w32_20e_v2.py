...
data_root = '/datasets/table0901/TableBank/Detection/'
img_norm_cfg = dict(
...
data = dict(
    ...
    test=dict(
        type=dataset_type,
        ann_file=data_root + '/datasets/table0901/TableBank/Detection/annotations/tablebank_word_test.json',
        img_prefix='/datasets/table0901/TableBank/Detection/images/',
        pipeline=test_pipeline))
...
log_level = 'INFO'
work_dir = '/home/tml/vansin/lab-try/mmdetection/work_dirs/table_v1'
load_from = None
# resume_from = '/content/drive/My Drive/Mmdetection/new_chunk_cascade_mask_rcnn_hrnetv2p_w32_20e/epoch_30.pth'
resume_from = '/home/tml/vansin/lab-try/mmdetection/checkpoints/epoch_13.pth'
# resume_from = None
workflow = [('train', 1)]