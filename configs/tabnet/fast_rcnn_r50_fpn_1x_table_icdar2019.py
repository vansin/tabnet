...
#     '../_base_/datasets/table_icdar2019.py',
...
data = dict(
    ...
    train=dict(
        ...
        proposal_file='work_dirs/rpn_r50_fpn_1x_icdar2019/epoch_12.pkl'),
    val=dict(
        type='TableDataset',
        ann_file='data/icdar2019/test.json',
        img_prefix='data/icdar2019/test/TRACKA/',
...
resume_from = None
workflow = [('train', 1)]
work_dir = './work_dirs/fast_rcnn_r50_fpn_1x_table_icdar2019'
gpu_ids = range(0, 1)
